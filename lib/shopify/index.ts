...
// Import cached functions from server file
import {
    getCollection,
...
// Re-export cached functions for external use
export {
    getCollection,
    getCollectionProducts,
    getCollections,
...
// Re-export revalidate function from server file
    export { revalidate } from './revalidate';

// Re-export cart functions from server file
export {
    addToCart,
    createCart,
    getCart,
